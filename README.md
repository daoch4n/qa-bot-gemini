...
- For Pull Requests, detailed review feedback will be commented on completion with `Resolve conversation` button <br> along with AI-actionable JSON report (in two formats) <br> auto-commited by your custom [bot] to your repo `/reviews/` folder (separate from main branch commits feedback)
